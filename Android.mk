...
LOCAL_MODULE := openvmid
LOCAL_INIT_RC := android/openvmid.rc
LOCAL_SRC_FILES := \
    ...
    src/openvmi/common/fd.cpp \
    src/openvmi/common/wait_handle.cpp \
    src/openvmi/rpc/message_processor.cpp \
    src/openvmi/rpc/pending_call_cache.cpp \
    src/openvmi/rpc/channel.cpp \
    src/openvmi/protobuf/openvmi_rpc.proto \
    src/openvmi/protobuf/openvmi_bridge.proto
proto_header_dir := $(call local-generated-sources-dir)/proto/$(LOCAL_PATH)/src/openvmi/protobuf
LOCAL_C_INCLUDES += \
    $(proto_header_dir) \
    $(LOCAL_PATH)/external/process-cpp-minimal/include \
    $(LOCAL_PATH)/src \
...
LOCAL_MODULE := hwcomposer.openvmi
