...
__eglMustCastToProperFunctionPointerType gles_getProcAddress(
        const char *procname) {
...
void glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat,
        ...
        const GLvoid *data) {
    getDispatch()->glCompressedTexImage2D(target, level, internalformat, width,
...
void glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset,
    ...
    getDispatch()->glCompressedTexSubImage2D(target, level, xoffset, yoffset,
            width, height, format, imageSize, data);
}

void glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat,
        GLint x, GLint y, GLsizei width, GLsizei height, GLint border) {
    getDispatch()->glCopyTexImage2D(target, level, internalformat, x, y, width,
            height, border);
}

void glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset,
        GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
    getDispatch()->glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y,
            width, height);
}
...
void glTexImage2D(GLenum target, GLint level, GLint internalformat,
        ...
        const GLvoid *pixels) {
    getDispatch()->glTexImage2D(target, level, internalformat, width, height,
...
void glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
        ...
        const GLvoid *pixels) {
    getDispatch()->glTexSubImage2D(target, level, xoffset, yoffset, width,
...
void glClearColorxOES(GLclampx red, GLclampx green, GLclampx blue,
        GLclampx alpha) {
...
void glFrustumxOES(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top,
        GLfixed zNear, GLfixed zFar) {
...
void glMultiTexCoord4xOES(GLenum target, GLfixed s, GLfixed t, GLfixed r,
        GLfixed q) {
...
void glOrthoxOES(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top,
        GLfixed zNear, GLfixed zFar) {
...
void glRenderbufferStorageOES(GLenum target, GLenum internalformat,
    ...
    getDispatch()->glRenderbufferStorageOES(target, internalformat, width,
            height);
}
...
void glFramebufferRenderbufferOES(GLenum target, GLenum attachment,
    ...
    getDispatch()->glFramebufferRenderbufferOES(target, attachment,
            renderbuffertarget, renderbuffer);
}

void glFramebufferTexture2DOES(GLenum target, GLenum attachment,
        GLenum textarget, GLuint texture, GLint level) {
    getDispatch()->glFramebufferTexture2DOES(target, attachment, textarget,
            texture, level);
}

void glGetFramebufferAttachmentParameterivOES(GLenum target, GLenum attachment,
        GLenum pname, GLint *params) {
    getDispatch()->glGetFramebufferAttachmentParameterivOES(target, attachment,
            pname, params);
}
...
void glFrustumfOES(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top,
        GLfloat zNear, GLfloat zFar) {
    getDispatch()->glFrustumfOES(left, right, bottom, top, zNear, zFar);
}

void glOrthofOES(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top,
        GLfloat zNear, GLfloat zFar) {
...
void glMultiDrawArraysEXT(GLenum mode, GLint *first, GLsizei *count,
        GLsizei primcount) {
...
void glMultiDrawElementsEXT(GLenum mode, const GLsizei *count, GLenum type,
    ...
    getDispatch()->glMultiDrawElementsEXT(mode, count, type, indices,
            primcount);
}
...
void glRenderbufferStorageMultisampleIMG(GLenum target, GLsizei samples,
        GLenum internalformat, GLsizei width, GLsizei height) {
    getDispatch()->glRenderbufferStorageMultisampleIMG(target, samples,
            internalformat, width, height);
}

void glFramebufferTexture2DMultisampleIMG(GLenum target, GLenum attachment,
        GLenum textarget, GLuint texture, GLint level, GLsizei samples) {
    getDispatch()->glFramebufferTexture2DMultisampleIMG(target, attachment,
...
void glGetDriverControlStringQCOM(GLuint driverControl, GLsizei bufSize,
        GLsizei *length, GLchar *driverControlString) {
    getDispatch()->glGetDriverControlStringQCOM(driverControl, bufSize, length,
            driverControlString);
}
...
void glExtGetTexturesQCOM(GLuint *textures, GLint maxTextures,
        GLint *numTextures) {
...
void glExtGetRenderbuffersQCOM(GLuint *renderbuffers, GLint maxRenderbuffers,
        GLint *numRenderbuffers) {
    getDispatch()->glExtGetRenderbuffersQCOM(renderbuffers, maxRenderbuffers,
            numRenderbuffers);
}

void glExtGetFramebuffersQCOM(GLuint *framebuffers, GLint maxFramebuffers,
        GLint *numFramebuffers) {
    getDispatch()->glExtGetFramebuffersQCOM(framebuffers, maxFramebuffers,
            numFramebuffers);
}

void glExtGetTexLevelParameterivQCOM(GLuint texture, GLenum face, GLint level,
        GLenum pname, GLint *params) {
    getDispatch()->glExtGetTexLevelParameterivQCOM(texture, face, level, pname,
            params);
}

void glExtTexObjectStateOverrideiQCOM(GLenum target, GLenum pname,
        GLint param) {
    getDispatch()->glExtTexObjectStateOverrideiQCOM(target, pname, param);
}

void glExtGetTexSubImageQCOM(GLenum target, GLint level, GLint xoffset,
        GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
        GLsizei depth, GLenum format, GLenum type, GLvoid *texels) {
    getDispatch()->glExtGetTexSubImageQCOM(target, level, xoffset, yoffset,
...
void glExtGetProgramBinarySourceQCOM(GLuint program, GLenum shadertype,
        GLchar *source, GLint *length) {
    getDispatch()->glExtGetProgramBinarySourceQCOM(program, shadertype, source,
            length);
}

void glStartTilingQCOM(GLuint x, GLuint y, GLuint width, GLuint height,
