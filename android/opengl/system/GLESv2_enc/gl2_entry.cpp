...
void glFramebufferTexture3DOES(GLenum target, GLenum attachment,
...
void glGetPerfMonitorGroupsAMD(GLint *numGroups, GLsizei groupsSize,
        GLuint *groups);
void glGetPerfMonitorCountersAMD(GLuint group, GLint *numCounters,
        GLint *maxActiveCounters, GLsizei counterSize, GLuint *counters);
void glGetPerfMonitorGroupStringAMD(GLuint group, GLsizei bufSize,
        GLsizei *length, GLchar *groupString);
void glGetPerfMonitorCounterStringAMD(GLuint group, GLuint counter,
        GLsizei bufSize, GLsizei *length, GLchar *counterString);
void glGetPerfMonitorCounterInfoAMD(GLuint group, GLuint counter, GLenum pname,
        GLvoid *data);
void glGenPerfMonitorsAMD(GLsizei n, GLuint *monitors);
void glDeletePerfMonitorsAMD(GLsizei n, GLuint *monitors);
void glSelectPerfMonitorCountersAMD(GLuint monitor, GLboolean enable,
        GLuint group, GLint numCounters, GLuint *countersList);
void glBeginPerfMonitorAMD(GLuint monitor);
void glEndPerfMonitorAMD(GLuint monitor);
void glGetPerfMonitorCounterDataAMD(GLuint monitor, GLenum pname,
...
void glVertexAttribPointerOffset(GLuint indx, GLint size, GLenum type,
        GLboolean normalized, GLsizei stride, GLuint offset);
void glDrawElementsOffset(GLenum mode, GLsizei count, GLenum type,
        GLuint offset);
void glDrawElementsData(GLenum mode, GLsizei count, GLenum type, void *data,
        GLuint datalen);
...
void gl2_client_context_t::setContextAccessor(CONTEXT_ACCESSOR_TYPE *f) {
    getCurrentContext = f;
}
...
void glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat,
        ...
        const GLvoid *data) {
    GET_CONTEXT;
    ctx->glCompressedTexImage2D(ctx, target, level, internalformat, width,
...
void glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset,
        ...
        GLsizei imageSize, const GLvoid *data) {
    GET_CONTEXT;
    ctx->glCompressedTexSubImage2D(ctx, target, level, xoffset, yoffset, width,
...
void glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat,
        GLint x, GLint y, GLsizei width, GLsizei height, GLint border) {
    GET_CONTEXT;
    ctx->glCopyTexImage2D(ctx, target, level, internalformat, x, y, width,
            height, border);
}
...
void glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset,
        GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
    GET_CONTEXT;
    ctx->glCopyTexSubImage2D(ctx, target, level, xoffset, yoffset, x, y, width,
            height);
}
...
void glFramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget,
        GLuint texture, GLint level) {
    GET_CONTEXT;
    ctx->glFramebufferTexture2D(ctx, target, attachment, textarget, texture,
            level);
}
...
void glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufsize,
        GLsizei *length, GLint *size, GLenum *type, GLchar *name) {
    GET_CONTEXT;
    ctx->glGetActiveAttrib(ctx, program, index, bufsize, length, size, type,
            name);
}
...
void glGetActiveUniform(GLuint program, GLuint index, GLsizei bufsize,
        GLsizei *length, GLint *size, GLenum *type, GLchar *name) {
    GET_CONTEXT;
    ctx->glGetActiveUniform(ctx, program, index, bufsize, length, size, type,
            name);
}
...
void glGetFramebufferAttachmentParameteriv(GLenum target, GLenum attachment,
        GLenum pname, GLint *params) {
    GET_CONTEXT;
    ctx->glGetFramebufferAttachmentParameteriv(ctx, target, attachment, pname,
            params);
}
...
void glGetShaderPrecisionFormat(GLenum shadertype, GLenum precisiontype,
        GLint *range, GLint *precision) {
    GET_CONTEXT;
    ctx->glGetShaderPrecisionFormat(ctx, shadertype, precisiontype, range,
            precision);
}
...
void glTexImage2D(GLenum target, GLint level, GLint internalformat,
        ...
        const GLvoid *pixels) {
    GET_CONTEXT;
    ctx->glTexImage2D(ctx, target, level, internalformat, width, height, border,
            format, type, pixels);
}
...
void glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
        ...
        const GLvoid *pixels) {
    GET_CONTEXT;
    ctx->glTexSubImage2D(ctx, target, level, xoffset, yoffset, width, height,
            format, type, pixels);
}
...
void glGetProgramBinaryOES(GLuint program, GLsizei bufSize, GLsizei *length,
        GLenum *binaryFormat, GLvoid *binary) {
    GET_CONTEXT;
    ctx->glGetProgramBinaryOES(ctx, program, bufSize, length, binaryFormat,
            binary);
}
...
void glTexImage3DOES(GLenum target, GLint level, GLenum internalformat,
        ...
        GLenum format, GLenum type, const GLvoid *pixels) {
    GET_CONTEXT;
    ctx->glTexImage3DOES(ctx, target, level, internalformat, width, height,
...
void glTexSubImage3DOES(GLenum target, GLint level, GLint xoffset,
        ...
        GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels) {
    GET_CONTEXT;
    ctx->glTexSubImage3DOES(ctx, target, level, xoffset, yoffset, zoffset,
...
void glCopyTexSubImage3DOES(GLenum target, GLint level, GLint xoffset,
        ...
        GLsizei height) {
    GET_CONTEXT;
    ctx->glCopyTexSubImage3DOES(ctx, target, level, xoffset, yoffset, zoffset,
            x, y, width, height);
}
...
void glCompressedTexImage3DOES(GLenum target, GLint level,
        ...
        GLint border, GLsizei imageSize, const GLvoid *data) {
    GET_CONTEXT;
    ctx->glCompressedTexImage3DOES(ctx, target, level, internalformat, width,
...
void glCompressedTexSubImage3DOES(GLenum target, GLint level, GLint xoffset,
        ...
        GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data) {
    GET_CONTEXT;
    ctx->glCompressedTexSubImage3DOES(ctx, target, level, xoffset, yoffset,
...
void glFramebufferTexture3DOES(GLenum target, GLenum attachment,
        GLenum textarget, GLuint texture, GLint level, GLint zoffset) {
    GET_CONTEXT;
    ctx->glFramebufferTexture3DOES(ctx, target, attachment, textarget, texture,
            level, zoffset);
}
...
void glGetPerfMonitorCountersAMD(GLuint group, GLint *numCounters,
        GLint *maxActiveCounters, GLsizei counterSize, GLuint *counters) {
    GET_CONTEXT;
    ctx->glGetPerfMonitorCountersAMD(ctx, group, numCounters, maxActiveCounters,
...
void glGetPerfMonitorGroupStringAMD(GLuint group, GLsizei bufSize,
        GLsizei *length, GLchar *groupString) {
    GET_CONTEXT;
    ctx->glGetPerfMonitorGroupStringAMD(ctx, group, bufSize, length,
            groupString);
}
...
void glGetPerfMonitorCounterStringAMD(GLuint group, GLuint counter,
        GLsizei bufSize, GLsizei *length, GLchar *counterString) {
    GET_CONTEXT;
    ctx->glGetPerfMonitorCounterStringAMD(ctx, group, counter, bufSize, length,
            counterString);
}
...
void glSelectPerfMonitorCountersAMD(GLuint monitor, GLboolean enable,
        GLuint group, GLint numCounters, GLuint *countersList) {
    GET_CONTEXT;
    ctx->glSelectPerfMonitorCountersAMD(ctx, monitor, enable, group,
...
void glGetPerfMonitorCounterDataAMD(GLuint monitor, GLenum pname,
        GLsizei dataSize, GLuint *data, GLint *bytesWritten) {
    GET_CONTEXT;
    ctx->glGetPerfMonitorCounterDataAMD(ctx, monitor, pname, dataSize, data,
            bytesWritten);
}
...
void glRenderbufferStorageMultisampleIMG(GLenum target, GLsizei samples,
        GLenum internalformat, GLsizei width, GLsizei height) {
    GET_CONTEXT;
    ctx->glRenderbufferStorageMultisampleIMG(ctx, target, samples,
...
void glFramebufferTexture2DMultisampleIMG(GLenum target, GLenum attachment,
        GLenum textarget, GLuint texture, GLint level, GLsizei samples) {
    GET_CONTEXT;
    ctx->glFramebufferTexture2DMultisampleIMG(ctx, target, attachment,
...
void glGetDriverControlStringQCOM(GLuint driverControl, GLsizei bufSize,
        GLsizei *length, GLchar *driverControlString) {
    GET_CONTEXT;
    ctx->glGetDriverControlStringQCOM(ctx, driverControl, bufSize, length,
            driverControlString);
}
...
void glExtGetRenderbuffersQCOM(GLuint *renderbuffers, GLint maxRenderbuffers,
        GLint *numRenderbuffers) {
    GET_CONTEXT;
    ctx->glExtGetRenderbuffersQCOM(ctx, renderbuffers, maxRenderbuffers,
            numRenderbuffers);
}
...
void glExtGetFramebuffersQCOM(GLuint *framebuffers, GLint maxFramebuffers,
        GLint *numFramebuffers) {
    GET_CONTEXT;
    ctx->glExtGetFramebuffersQCOM(ctx, framebuffers, maxFramebuffers,
            numFramebuffers);
}
...
void glExtGetTexLevelParameterivQCOM(GLuint texture, GLenum face, GLint level,
        GLenum pname, GLint *params) {
    GET_CONTEXT;
    ctx->glExtGetTexLevelParameterivQCOM(ctx, texture, face, level, pname,
            params);
}
...
void glExtGetTexSubImageQCOM(GLenum target, GLint level, GLint xoffset,
        ...
        GLsizei depth, GLenum format, GLenum type, GLvoid *texels) {
    GET_CONTEXT;
    ctx->glExtGetTexSubImageQCOM(ctx, target, level, xoffset, yoffset, zoffset,
...
void glExtGetProgramBinarySourceQCOM(GLuint program, GLenum shadertype,
        GLchar *source, GLint *length) {
    GET_CONTEXT;
    ctx->glExtGetProgramBinarySourceQCOM(ctx, program, shadertype, source,
            length);
}
...
void glVertexAttribPointerData(GLuint indx, GLint size, GLenum type,
        GLboolean normalized, GLsizei stride, void *data, GLuint datalen) {
    GET_CONTEXT;
    ctx->glVertexAttribPointerData(ctx, indx, size, type, normalized, stride,
            data, datalen);
}
...
void glVertexAttribPointerOffset(GLuint indx, GLint size, GLenum type,
        GLboolean normalized, GLsizei stride, GLuint offset) {
    GET_CONTEXT;
    ctx->glVertexAttribPointerOffset(ctx, indx, size, type, normalized, stride,
            offset);
}
