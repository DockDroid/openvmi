...
void glAlphaFunc_enc(void *self, GLenum func, GLclampf ref) {
    ...
    ptr = buf;
    int tmp = OP_glAlphaFunc;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(buf, ptr - buf);
    if (useChecksum)
        checksumCalculator->writeChecksum(ptr, checksumSize);
    ptr += checksumSize;

}

void glClearColor_enc(void *self, GLclampf red, GLclampf green, GLclampf blue,
        GLclampf alpha) {
...
void glClipPlanef_enc(void *self, GLenum plane, const GLfloat *equation) {
    ...
    memcpy(ptr, &plane, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_equation;
    ptr += 4;
    memcpy(ptr, equation, __size_equation);
    ptr += __size_equation;
...
void glColor4f_enc(void *self, GLfloat red, GLfloat green, GLfloat blue,
        GLfloat alpha) {
...
void glFogfv_enc(void *self, GLenum pname, const GLfloat *params) {
    ...
    const unsigned int __size_params = (glUtilsParamSize(pname)
            * sizeof(GLfloat));
    unsigned char *ptr;
    unsigned char *buf;
    ...
    memcpy(ptr, &pname, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_params;
    ptr += 4;
    memcpy(ptr, params, __size_params);
    ptr += __size_params;
...
void glFrustumf_enc(void *self, GLfloat left, GLfloat right, GLfloat bottom,
...
void glGetClipPlanef_enc(void *self, GLenum pname, GLfloat *eqn) {
    ...
    *(unsigned int*) (ptr) = __size_eqn;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(eqn, __size_eqn);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetClipPlanef: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetFloatv_enc(void *self, GLenum pname, GLfloat *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(params, __size_params);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetFloatv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetLightfv_enc(void *self, GLenum light, GLenum pname, GLfloat *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetLightfv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetMaterialfv_enc(void *self, GLenum face, GLenum pname,
        GLfloat *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetMaterialfv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetTexEnvfv_enc(void *self, GLenum env, GLenum pname, GLfloat *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexEnvfv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetTexParameterfv_enc(void *self, GLenum target, GLenum pname,
        GLfloat *params) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetTexParameterfv;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexParameterfv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glLightfv_enc(void *self, GLenum light, GLenum pname,
...
void glLoadMatrixf_enc(void *self, const GLfloat *m) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glLoadMatrixf;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    *(unsigned int*) (ptr) = __size_m;
    ptr += 4;
    memcpy(ptr, m, __size_m);
    ptr += __size_m;
...
void glMaterialfv_enc(void *self, GLenum face, GLenum pname,
        const GLfloat *params) {
...
void glMultiTexCoord4f_enc(void *self, GLenum target, GLfloat s, GLfloat t,
        GLfloat r, GLfloat q) {
...
void glOrthof_enc(void *self, GLfloat left, GLfloat right, GLfloat bottom,
        GLfloat top, GLfloat zNear, GLfloat zFar) {
...
void glTexEnvfv_enc(void *self, GLenum target, GLenum pname,
        const GLfloat *params) {
...
void glTexParameterf_enc(void *self, GLenum target, GLenum pname,
        GLfloat param) {
...
void glTexParameterfv_enc(void *self, GLenum target, GLenum pname,
        const GLfloat *params) {
...
void glActiveTexture_enc(void *self, GLenum texture) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glActiveTexture;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &texture, 4);
    ptr += 4;
...
void glBlendFunc_enc(void *self, GLenum sfactor, GLenum dfactor) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glBlendFunc;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &sfactor, 4);
    ptr += 4;
    memcpy(ptr, &dfactor, 4);
    ptr += 4;
...
void glBufferData_enc(void *self, GLenum target, GLsizeiptr size,
    ...
    memcpy(ptr, &size, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_data;
    ptr += 4;
    if (data != NULL)
        memcpy(ptr, data, __size_data);
    ptr += __size_data;
    memcpy(ptr, &usage, 4);
    ptr += 4;
...
void glBufferSubData_enc(void *self, GLenum target, GLintptr offset,
...
void glClearColorx_enc(void *self, GLclampx red, GLclampx green, GLclampx blue,
        GLclampx alpha) {
...
void glClientActiveTexture_enc(void *self, GLenum texture) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glClientActiveTexture;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glColor4ub_enc(void *self, GLubyte red, GLubyte green, GLubyte blue,
        GLubyte alpha) {
...
void glColor4x_enc(void *self, GLfixed red, GLfixed green, GLfixed blue,
        GLfixed alpha) {
...
void glColorMask_enc(void *self, GLboolean red, GLboolean green, GLboolean blue,
        GLboolean alpha) {
...
void glCompressedTexImage2D_enc(void *self, GLenum target, GLint level,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glCompressedTexImage2D;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glCompressedTexSubImage2D_enc(void *self, GLenum target, GLint level,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glCompressedTexSubImage2D;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &level, 4);
    ptr += 4;
    memcpy(ptr, &xoffset, 4);
    ptr += 4;
    memcpy(ptr, &yoffset, 4);
    ptr += 4;
    memcpy(ptr, &width, 4);
    ptr += 4;
    memcpy(ptr, &height, 4);
...
void glCopyTexImage2D_enc(void *self, GLenum target, GLint level,
...
void glCopyTexSubImage2D_enc(void *self, GLenum target, GLint level,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glCopyTexSubImage2D;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glDeleteBuffers_enc(void *self, GLsizei n, const GLuint *buffers) {
    ...
    memcpy(ptr, &n, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_buffers;
    ptr += 4;
    memcpy(ptr, buffers, __size_buffers);
    ptr += __size_buffers;
...
void glDeleteTextures_enc(void *self, GLsizei n, const GLuint *textures) {
    ...
    memcpy(ptr, &n, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_textures;
    ptr += 4;
    memcpy(ptr, textures, __size_textures);
    ptr += __size_textures;
...
void glDisableClientState_enc(void *self, GLenum array) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDisableClientState;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glEnableClientState_enc(void *self, GLenum array) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glEnableClientState;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glFrustumx_enc(void *self, GLfixed left, GLfixed right, GLfixed bottom,
...
void glGetBooleanv_enc(void *self, GLenum pname, GLboolean *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetBooleanv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetBufferParameteriv_enc(void *self, GLenum target, GLenum pname,
        GLint *params) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetBufferParameteriv;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetBufferParameteriv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGenBuffers_enc(void *self, GLsizei n, GLuint *buffers) {
    ...
    *(unsigned int*) (ptr) = __size_buffers;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(buffers, __size_buffers);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGenBuffers: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGenTextures_enc(void *self, GLsizei n, GLuint *textures) {
    ...
    *(unsigned int*) (ptr) = __size_textures;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(textures, __size_textures);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGenTextures: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
GLenum glGetError_enc(void *self) {
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(&retval, 4);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetError: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glGetFixedv_enc(void *self, GLenum pname, GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetFixedv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetIntegerv_enc(void *self, GLenum pname, GLint *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetIntegerv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetLightxv_enc(void *self, GLenum light, GLenum pname, GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetLightxv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetMaterialxv_enc(void *self, GLenum face, GLenum pname,
        GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetMaterialxv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetTexEnviv_enc(void *self, GLenum env, GLenum pname, GLint *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexEnviv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetTexEnvxv_enc(void *self, GLenum env, GLenum pname, GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexEnvxv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetTexParameteriv_enc(void *self, GLenum target, GLenum pname,
        GLint *params) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetTexParameteriv;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexParameteriv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetTexParameterxv_enc(void *self, GLenum target, GLenum pname,
        GLfixed *params) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetTexParameterxv;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexParameterxv: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
GLboolean glIsBuffer_enc(void *self, GLuint buffer) {
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(&retval, 1);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glIsBuffer: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
GLboolean glIsEnabled_enc(void *self, GLenum cap) {
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glIsEnabled: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
GLboolean glIsTexture_enc(void *self, GLuint texture) {
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glIsTexture: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glLightxv_enc(void *self, GLenum light, GLenum pname,
...
void glMaterialxv_enc(void *self, GLenum face, GLenum pname,
        const GLfixed *params) {
...
void glMultiTexCoord4x_enc(void *self, GLenum target, GLfixed s, GLfixed t,
        GLfixed r, GLfixed q) {
...
void glOrthox_enc(void *self, GLfixed left, GLfixed right, GLfixed bottom,
        GLfixed top, GLfixed zNear, GLfixed zFar) {
...
void glReadPixels_enc(void *self, GLint x, GLint y, GLsizei width,
    ...
    const unsigned int __size_pixels = glesv1_enc::pixelDataSize(self, width,
            height, format, type, 1);
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + 4 + 4 + 4 + 4 + 4 + 4 + __size_pixels
            + 1 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glReadPixels;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &type, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_pixels;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(pixels, __size_pixels);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glReadPixels: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glScissor_enc(void *self, GLint x, GLint y, GLsizei width,
        GLsizei height) {
...
void glTexEnviv_enc(void *self, GLenum target, GLenum pname,
        const GLint *params) {
...
void glTexEnvxv_enc(void *self, GLenum target, GLenum pname,
        const GLfixed *params) {
...
void glTexImage2D_enc(void *self, GLenum target, GLint level,
    ...
    const unsigned int __size_pixels = (
            (pixels != NULL) ?
                    glesv1_enc::pixelDataSize(self, width, height, format, type,
                            0) :
                    0);
    unsigned char *ptr;
    unsigned char *buf;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(&__size_pixels, 4);
    if (pixels != NULL) {
    ...
    if (useChecksum)
        checksumCalculator->writeChecksum(buf, checksumSize);
...
void glTexParameterx_enc(void *self, GLenum target, GLenum pname,
        GLfixed param) {
...
void glTexParameteriv_enc(void *self, GLenum target, GLenum pname,
        const GLint *params) {
...
void glTexParameterxv_enc(void *self, GLenum target, GLenum pname,
        const GLfixed *params) {
...
void glTexSubImage2D_enc(void *self, GLenum target, GLint level, GLint xoffset,
...
void glViewport_enc(void *self, GLint x, GLint y, GLsizei width,
        GLsizei height) {
...
void glVertexPointerOffset_enc(void *self, GLint size, GLenum type,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glVertexPointerOffset;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glColorPointerOffset_enc(void *self, GLint size, GLenum type,
        GLsizei stride, GLuint offset) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glColorPointerOffset;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glNormalPointerOffset_enc(void *self, GLenum type, GLsizei stride,
        GLuint offset) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glNormalPointerOffset;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glPointSizePointerOffset_enc(void *self, GLenum type, GLsizei stride,
        GLuint offset) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glPointSizePointerOffset;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glTexCoordPointerOffset_enc(void *self, GLint size, GLenum type,
        GLsizei stride, GLuint offset) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glTexCoordPointerOffset;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glWeightPointerOffset_enc(void *self, GLint size, GLenum type,
        GLsizei stride, GLuint offset) {
...
void glMatrixIndexPointerOffset_enc(void *self, GLint size, GLenum type,
        GLsizei stride, GLuint offset) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glMatrixIndexPointerOffset;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glVertexPointerData_enc(void *self, GLint size, GLenum type,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glVertexPointerData;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_data;
    ptr += 4;
    glUtilsPackPointerData((unsigned char*) ptr, (unsigned char*) data, size,
            type, stride, datalen);
    ptr += __size_data;
    memcpy(ptr, &datalen, 4);
    ptr += 4;
...
void glColorPointerData_enc(void *self, GLint size, GLenum type, GLsizei stride,
...
void glNormalPointerData_enc(void *self, GLenum type, GLsizei stride,
        void *data, GLuint datalen) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glNormalPointerData;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_data;
    ptr += 4;
    glUtilsPackPointerData((unsigned char*) ptr, (unsigned char*) data, 3, type,
            stride, datalen);
    ptr += __size_data;
    memcpy(ptr, &datalen, 4);
    ptr += 4;
...
void glTexCoordPointerData_enc(void *self, GLint unit, GLint size, GLenum type,
        GLsizei stride, void *data, GLuint datalen) {
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + 4 + 4 + 4 + 4 + __size_data + 4
            + 1 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glTexCoordPointerData;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glPointSizePointerData_enc(void *self, GLenum type, GLsizei stride,
        void *data, GLuint datalen) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glPointSizePointerData;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_data;
    ptr += 4;
    glUtilsPackPointerData((unsigned char*) ptr, (unsigned char*) data, 1, type,
            stride, datalen);
    ptr += __size_data;
    memcpy(ptr, &datalen, 4);
    ptr += 4;
...
void glWeightPointerData_enc(void *self, GLint size, GLenum type,
        GLsizei stride, void *data, GLuint datalen) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glWeightPointerData;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glMatrixIndexPointerData_enc(void *self, GLint size, GLenum type,
        GLsizei stride, void *data, GLuint datalen) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glMatrixIndexPointerData;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glDrawElementsOffset_enc(void *self, GLenum mode, GLsizei count,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDrawElementsOffset;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glDrawElementsData_enc(void *self, GLenum mode, GLsizei count, GLenum type,
        void *data, GLuint datalen) {
...
void glGetCompressedTextureFormats_enc(void *self, int count, GLint *formats) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetCompressedTextureFormats;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &count, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_formats;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(formats, __size_formats);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetCompressedTextureFormats: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
int glFinishRoundTrip_enc(void *self) {
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glFinishRoundTrip: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glBlendEquationSeparateOES_enc(void *self, GLenum modeRGB,
        GLenum modeAlpha) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glBlendEquationSeparateOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &modeRGB, 4);
    ptr += 4;
    memcpy(ptr, &modeAlpha, 4);
    ptr += 4;
...
void glBlendFuncSeparateOES_enc(void *self, GLenum srcRGB, GLenum dstRGB,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glBlendFuncSeparateOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &dstRGB, 4);
    ptr += 4;
    memcpy(ptr, &srcAlpha, 4);
    ptr += 4;
    memcpy(ptr, &dstAlpha, 4);
    ptr += 4;
...
void glDrawTexsOES_enc(void *self, GLshort x, GLshort y, GLshort z,
...
void glDrawTexiOES_enc(void *self, GLint x, GLint y, GLint z, GLint width,
        GLint height) {
...
void glDrawTexxOES_enc(void *self, GLfixed x, GLfixed y, GLfixed z,
...
void glDrawTexsvOES_enc(void *self, const GLshort *coords) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDrawTexsvOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    *(unsigned int*) (ptr) = __size_coords;
    ptr += 4;
    memcpy(ptr, coords, __size_coords);
    ptr += __size_coords;
...
void glDrawTexfOES_enc(void *self, GLfloat x, GLfloat y, GLfloat z,
...
void glEGLImageTargetTexture2DOES_enc(void *self, GLenum target,
        GLeglImageOES image) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glEGLImageTargetTexture2DOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glEGLImageTargetRenderbufferStorageOES_enc(void *self, GLenum target,
        GLeglImageOES image) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glEGLImageTargetRenderbufferStorageOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glClearColorxOES_enc(void *self, GLclampx red, GLclampx green,
...
void glColor4xOES_enc(void *self, GLfixed red, GLfixed green, GLfixed blue,
        GLfixed alpha) {
...
void glGetClipPlanexOES_enc(void *self, GLenum pname, GLfixed *eqn) {
    ...
    *(unsigned int*) (ptr) = __size_eqn;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetClipPlanexOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetClipPlanex_enc(void *self, GLenum pname, GLfixed *eqn) {
    ...
    *(unsigned int*) (ptr) = __size_eqn;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetClipPlanex: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetFixedvOES_enc(void *self, GLenum pname, GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetFixedvOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetLightxvOES_enc(void *self, GLenum light, GLenum pname,
        GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetLightxvOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetMaterialxvOES_enc(void *self, GLenum face, GLenum pname,
        GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetMaterialxvOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetTexEnvxvOES_enc(void *self, GLenum env, GLenum pname,
        GLfixed *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexEnvxvOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetTexParameterxvOES_enc(void *self, GLenum target, GLenum pname,
        GLfixed *params) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetTexParameterxvOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetTexParameterxvOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glLightxvOES_enc(void *self, GLenum light, GLenum pname,
        const GLfixed *params) {
...
void glMaterialxvOES_enc(void *self, GLenum face, GLenum pname,
        const GLfixed *params) {
...
void glMultiTexCoord4xOES_enc(void *self, GLenum target, GLfixed s, GLfixed t,
        GLfixed r, GLfixed q) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glMultiTexCoord4xOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glOrthoxOES_enc(void *self, GLfixed left, GLfixed right, GLfixed bottom,
        GLfixed top, GLfixed zNear, GLfixed zFar) {
...
void glPointParameterxOES_enc(void *self, GLenum pname, GLfixed param) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glPointParameterxOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glPointParameterxvOES_enc(void *self, GLenum pname,
        const GLfixed *params) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glPointParameterxvOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glPolygonOffsetxOES_enc(void *self, GLfixed factor, GLfixed units) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glPolygonOffsetxOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glRotatexOES_enc(void *self, GLfixed angle, GLfixed x, GLfixed y,
        GLfixed z) {
...
void glSampleCoveragexOES_enc(void *self, GLclampx value, GLboolean invert) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glSampleCoveragexOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glTexEnvxvOES_enc(void *self, GLenum target, GLenum pname,
        const GLfixed *params) {
...
void glTexParameterxOES_enc(void *self, GLenum target, GLenum pname,
        GLfixed param) {
...
void glTexParameterxvOES_enc(void *self, GLenum target, GLenum pname,
        const GLfixed *params) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glTexParameterxvOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
GLboolean glIsRenderbufferOES_enc(void *self, GLuint renderbuffer) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glIsRenderbufferOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &renderbuffer, 4);
    ptr += 4;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glIsRenderbufferOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glBindRenderbufferOES_enc(void *self, GLenum target, GLuint renderbuffer) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glBindRenderbufferOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glDeleteRenderbuffersOES_enc(void *self, GLsizei n,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDeleteRenderbuffersOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &n, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_renderbuffers;
    ptr += 4;
    memcpy(ptr, renderbuffers, __size_renderbuffers);
    ptr += __size_renderbuffers;
...
void glGenRenderbuffersOES_enc(void *self, GLsizei n, GLuint *renderbuffers) {
    ...
    *(unsigned int*) (ptr) = __size_renderbuffers;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(renderbuffers, __size_renderbuffers);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGenRenderbuffersOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glRenderbufferStorageOES_enc(void *self, GLenum target,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glRenderbufferStorageOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glGetRenderbufferParameterivOES_enc(void *self, GLenum target,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetRenderbufferParameterivOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetRenderbufferParameterivOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
GLboolean glIsFramebufferOES_enc(void *self, GLuint framebuffer) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glIsFramebufferOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &framebuffer, 4);
    ptr += 4;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glIsFramebufferOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glBindFramebufferOES_enc(void *self, GLenum target, GLuint framebuffer) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glBindFramebufferOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glDeleteFramebuffersOES_enc(void *self, GLsizei n,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDeleteFramebuffersOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &n, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_framebuffers;
    ptr += 4;
    memcpy(ptr, framebuffers, __size_framebuffers);
    ptr += __size_framebuffers;
...
void glGenFramebuffersOES_enc(void *self, GLsizei n, GLuint *framebuffers) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGenFramebuffersOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_framebuffers;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(framebuffers, __size_framebuffers);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGenFramebuffersOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
GLenum glCheckFramebufferStatusOES_enc(void *self, GLenum target) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glCheckFramebufferStatusOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glCheckFramebufferStatusOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glFramebufferRenderbufferOES_enc(void *self, GLenum target,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glFramebufferRenderbufferOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &target, 4);
    ptr += 4;
    memcpy(ptr, &attachment, 4);
    ptr += 4;
    memcpy(ptr, &renderbuffertarget, 4);
    ptr += 4;
    memcpy(ptr, &renderbuffer, 4);
    ptr += 4;
...
void glFramebufferTexture2DOES_enc(void *self, GLenum target, GLenum attachment,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glFramebufferTexture2DOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glGetFramebufferAttachmentParameterivOES_enc(void *self, GLenum target,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetFramebufferAttachmentParameterivOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetFramebufferAttachmentParameterivOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGenerateMipmapOES_enc(void *self, GLenum target) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGenerateMipmapOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
GLboolean glUnmapBufferOES_enc(void *self, GLenum target) {
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glUnmapBufferOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glCurrentPaletteMatrixOES_enc(void *self, GLuint matrixpaletteindex) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glCurrentPaletteMatrixOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &matrixpaletteindex, 4);
    ptr += 4;
...
GLbitfield glQueryMatrixxOES_enc(void *self, GLfixed *mantissa,
        GLint *exponent) {
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_mantissa + __size_exponent
            + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glQueryMatrixxOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    *(unsigned int*) (ptr) = __size_mantissa;
    ptr += 4;
    *(unsigned int*) (ptr) = __size_exponent;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(mantissa, __size_mantissa);
    stream->readback(exponent, __size_exponent);
    if (useChecksum)
        checksumCalculator->addBuffer(exponent, __size_exponent);
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glQueryMatrixxOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glFrustumfOES_enc(void *self, GLfloat left, GLfloat right, GLfloat bottom,
        GLfloat top, GLfloat zNear, GLfloat zFar) {
...
void glOrthofOES_enc(void *self, GLfloat left, GLfloat right, GLfloat bottom,
        GLfloat top, GLfloat zNear, GLfloat zFar) {
...
void glGetClipPlanefOES_enc(void *self, GLenum pname, GLfloat *eqn) {
    ...
    *(unsigned int*) (ptr) = __size_eqn;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetClipPlanefOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glTexGenfvOES_enc(void *self, GLenum coord, GLenum pname,
        const GLfloat *params) {
...
void glTexGenivOES_enc(void *self, GLenum coord, GLenum pname,
        const GLint *params) {
...
void glTexGenxvOES_enc(void *self, GLenum coord, GLenum pname,
        const GLfixed *params) {
...
void glGetTexGenfvOES_enc(void *self, GLenum coord, GLenum pname,
        GLfloat *params) {
...
void glGetTexGenivOES_enc(void *self, GLenum coord, GLenum pname,
        GLint *params) {
...
void glGetTexGenxvOES_enc(void *self, GLenum coord, GLenum pname,
        GLfixed *params) {
...
void glBindVertexArrayOES_enc(void *self, GLuint array) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glBindVertexArrayOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glDeleteVertexArraysOES_enc(void *self, GLsizei n, const GLuint *arrays) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDeleteVertexArraysOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &n, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_arrays;
    ptr += 4;
...
void glGenVertexArraysOES_enc(void *self, GLsizei n, GLuint *arrays) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGenVertexArraysOES;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_arrays;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(arrays, __size_arrays);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGenVertexArraysOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
GLboolean glIsVertexArrayOES_enc(void *self, GLuint array) {
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glIsVertexArrayOES: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glDiscardFramebufferEXT_enc(void *self, GLenum target,
    ...
    const unsigned int __size_attachments = (numAttachments
            * sizeof(const GLenum));
    unsigned char *ptr;
    unsigned char *buf;
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDiscardFramebufferEXT;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &target, 4);
    ptr += 4;
    memcpy(ptr, &numAttachments, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_attachments;
    ptr += 4;
    memcpy(ptr, attachments, __size_attachments);
    ptr += __size_attachments;
...
void glRenderbufferStorageMultisampleIMG_enc(void *self, GLenum target,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glRenderbufferStorageMultisampleIMG;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glFramebufferTexture2DMultisampleIMG_enc(void *self, GLenum target,
...
void glDeleteFencesNV_enc(void *self, GLsizei n, const GLuint *fences) {
    ...
    memcpy(ptr, &n, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_fences;
    ptr += 4;
    memcpy(ptr, fences, __size_fences);
    ptr += __size_fences;
...
GLboolean glIsFenceNV_enc(void *self, GLuint fence) {
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glIsFenceNV: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
GLboolean glTestFenceNV_enc(void *self, GLuint fence) {
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glTestFenceNV: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glGetFenceivNV_enc(void *self, GLuint fence, GLenum pname, GLint *params) {
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetFenceivNV: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glGetDriverControlsQCOM_enc(void *self, GLint *num, GLsizei size,
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_num + 4
            + __size_driverControls + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetDriverControlsQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    *(unsigned int*) (ptr) = __size_num;
    ptr += 4;
    memcpy(ptr, &size, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_driverControls;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(num, __size_num);
    stream->readback(driverControls, __size_driverControls);
    if (useChecksum)
        checksumCalculator->addBuffer(driverControls, __size_driverControls);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetDriverControlsQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glGetDriverControlStringQCOM_enc(void *self, GLuint driverControl,
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + 4 + 4 + __size_length
            + __size_driverControlString + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glGetDriverControlStringQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &driverControl, 4);
    ptr += 4;
    memcpy(ptr, &bufSize, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_length;
    ptr += 4;
    *(unsigned int*) (ptr) = __size_driverControlString;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(length, __size_length);
    stream->readback(driverControlString, __size_driverControlString);
    if (useChecksum)
        checksumCalculator->addBuffer(driverControlString,
                __size_driverControlString);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glGetDriverControlStringQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
void glEnableDriverControlQCOM_enc(void *self, GLuint driverControl) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glEnableDriverControlQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glDisableDriverControlQCOM_enc(void *self, GLuint driverControl) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glDisableDriverControlQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glExtGetTexturesQCOM_enc(void *self, GLuint *textures, GLint maxTextures,
        GLint *numTextures) {
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_textures + 4
            + __size_numTextures + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetTexturesQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_textures;
    ptr += 4;
    memcpy(ptr, &maxTextures, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_numTextures;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(numTextures, __size_numTextures);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetTexturesQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glExtGetBuffersQCOM_enc(void *self, GLuint *buffers, GLint maxBuffers,
        GLint *numBuffers) {
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_buffers + 4
            + __size_numBuffers + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetBuffersQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_buffers;
    ptr += 4;
    memcpy(ptr, &maxBuffers, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_numBuffers;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(numBuffers, __size_numBuffers);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetBuffersQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glExtGetRenderbuffersQCOM_enc(void *self, GLuint *renderbuffers,
    ...
    const unsigned int __size_renderbuffers =
            (maxRenderbuffers * sizeof(GLuint));
    const unsigned int __size_numRenderbuffers = (1 * sizeof(GLint));
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_renderbuffers + 4
            + __size_numRenderbuffers + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetRenderbuffersQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_renderbuffers;
    ptr += 4;
    memcpy(ptr, &maxRenderbuffers, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_numRenderbuffers;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(numRenderbuffers,
                __size_numRenderbuffers);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetRenderbuffersQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glExtGetFramebuffersQCOM_enc(void *self, GLuint *framebuffers,
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_framebuffers + 4
            + __size_numFramebuffers + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetFramebuffersQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_framebuffers;
    ptr += 4;
    memcpy(ptr, &maxFramebuffers, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_numFramebuffers;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(numFramebuffers, __size_numFramebuffers);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetFramebuffersQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glExtGetTexLevelParameterivQCOM_enc(void *self, GLuint texture,
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + 4 + 4 + 4 + 4 + __size_params
            + 1 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetTexLevelParameterivQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    *(unsigned int*) (ptr) = __size_params;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetTexLevelParameterivQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glExtTexObjectStateOverrideiQCOM_enc(void *self, GLenum target,
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtTexObjectStateOverrideiQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
...
void glExtGetTexSubImageQCOM_enc(void *self, GLenum target, GLint level,
    ...
    const unsigned int __size_texels = (depth
            * glesv1_enc::pixelDataSize(self, width, height, format, type, 0));
    unsigned char *ptr;
    unsigned char *buf;
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetTexSubImageQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;
    ...
    memcpy(ptr, &type, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_texels;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(texels, __size_texels);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetTexSubImageQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glExtGetShadersQCOM_enc(void *self, GLuint *shaders, GLint maxShaders,
        GLint *numShaders) {
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_shaders + 4
            + __size_numShaders + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetShadersQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    *(unsigned int*) (ptr) = __size_shaders;
    ptr += 4;
    memcpy(ptr, &maxShaders, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_numShaders;
    ptr += 4;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(shaders, __size_shaders);
    stream->readback(numShaders, __size_numShaders);
    if (useChecksum)
        checksumCalculator->addBuffer(numShaders, __size_numShaders);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetShadersQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}

void glExtGetProgramsQCOM_enc(void *self, GLuint *programs, GLint maxPrograms,
        GLint *numPrograms) {
    ...
    unsigned char *ptr;
    unsigned char *buf;
    const size_t sizeWithoutChecksum = 8 + __size_programs + 4
            + __size_numPrograms + 2 * 4;
    const size_t checksumSize = checksumCalculator->checksumByteSize();
    const size_t totalSize = sizeWithoutChecksum + checksumSize;
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtGetProgramsQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    *(unsigned int*) (ptr) = __size_programs;
    ptr += 4;
    memcpy(ptr, &maxPrograms, 4);
    ptr += 4;
    *(unsigned int*) (ptr) = __size_numPrograms;
    ...
    if (useChecksum)
        checksumCalculator->addBuffer(programs, __size_programs);
    stream->readback(numPrograms, __size_numPrograms);
    if (useChecksum)
        checksumCalculator->addBuffer(numPrograms, __size_numPrograms);
    if (useChecksum) {
        std::unique_ptr<unsigned char[]> checksumBuf(
                new unsigned char[checksumSize]);
        stream->readback(checksumBuf.get(), checksumSize);
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtGetProgramsQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
}
...
GLboolean glExtIsProgramBinaryQCOM_enc(void *self, GLuint program) {
    ...
    buf = stream->alloc(totalSize);
    ptr = buf;
    int tmp = OP_glExtIsProgramBinaryQCOM;
    memcpy(ptr, &tmp, 4);
    ptr += 4;
    memcpy(ptr, &totalSize, 4);
    ptr += 4;

    memcpy(ptr, &program, 4);
    ptr += 4;
    ...
    if (useChecksum) {
        ...
        if (!checksumCalculator->validate(checksumBuf.get(), checksumSize)) {
            ALOGE(
                    "glExtIsProgramBinaryQCOM: GL communication error, please report this issue to b.android.com.\n");
            abort();
        }
    }
    return retval;
...
void glStartTilingQCOM_enc(void *self, GLuint x, GLuint y, GLuint width,
...
gl_encoder_context_t::gl_encoder_context_t(IOStream *stream,
    ...
    this->glTexCoordPointer = (glTexCoordPointer_client_proc_t)
            & enc_unsupported;
    ...
    this->glPointSizePointerOES = (glPointSizePointerOES_client_proc_t)
            & enc_unsupported;
    ...
    this->glEGLImageTargetRenderbufferStorageOES =
            &glEGLImageTargetRenderbufferStorageOES_enc;
    ...
    this->glGetRenderbufferParameterivOES =
            &glGetRenderbufferParameterivOES_enc;
    ...
    this->glGetFramebufferAttachmentParameterivOES =
    ...
    this->glMultiDrawArraysEXT = (glMultiDrawArraysEXT_client_proc_t)
            & enc_unsupported;
    this->glMultiDrawElementsEXT = (glMultiDrawElementsEXT_client_proc_t)
            & enc_unsupported;
    this->glMultiDrawArraysSUN = (glMultiDrawArraysSUN_client_proc_t)
            & enc_unsupported;
    this->glMultiDrawElementsSUN = (glMultiDrawElementsSUN_client_proc_t)
            & enc_unsupported;
    this->glRenderbufferStorageMultisampleIMG =
            &glRenderbufferStorageMultisampleIMG_enc;
    this->glFramebufferTexture2DMultisampleIMG =
            &glFramebufferTexture2DMultisampleIMG_enc;
    ...
    this->glExtGetTexLevelParameterivQCOM =
            &glExtGetTexLevelParameterivQCOM_enc;
    this->glExtTexObjectStateOverrideiQCOM =
            &glExtTexObjectStateOverrideiQCOM_enc;
    this->glExtGetTexSubImageQCOM = &glExtGetTexSubImageQCOM_enc;
    this->glExtGetBufferPointervQCOM =
            (glExtGetBufferPointervQCOM_client_proc_t) & enc_unsupported;
    ...
    this->glExtGetProgramBinarySourceQCOM =
            (glExtGetProgramBinarySourceQCOM_client_proc_t) & enc_unsupported;
