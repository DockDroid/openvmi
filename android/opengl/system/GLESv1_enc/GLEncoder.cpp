...
void GLEncoder::s_glVertexPointer(void *self, int size, GLenum type,
        GLsizei stride, const void *data) {
    GLEncoder *ctx = (GLEncoder*) self;
    assert(ctx->m_state != NULL);
    ctx->m_state->setState(GLClientState::VERTEX_LOCATION, size, type, false,
            stride, data);
}

void GLEncoder::s_glNormalPointer(void *self, GLenum type, GLsizei stride,
        const void *data) {
    GLEncoder *ctx = (GLEncoder*) self;
    assert(ctx->m_state != NULL);
    ctx->m_state->setState(GLClientState::NORMAL_LOCATION, 3, type, false,
            stride, data);
}

void GLEncoder::s_glColorPointer(void *self, int size, GLenum type,
        GLsizei stride, const void *data) {
    GLEncoder *ctx = (GLEncoder*) self;
    assert(ctx->m_state != NULL);
    ctx->m_state->setState(GLClientState::COLOR_LOCATION, size, type, false,
            stride, data);
}

void GLEncoder::s_glPointSizePointerOES(void *self, GLenum type, GLsizei stride,
        const void *data) {
    GLEncoder *ctx = (GLEncoder*) self;
    assert(ctx->m_state != NULL);
    ctx->m_state->setState(GLClientState::POINTSIZE_LOCATION, 1, type, false,
            stride, data);
}
...
void GLEncoder::s_glTexCoordPointer(void *self, int size, GLenum type,
        GLsizei stride, const void *data) {
    GLEncoder *ctx = (GLEncoder*) self;
    assert(ctx->m_state != NULL);
...
void GLEncoder::s_glMatrixIndexPointerOES(void *self, int size, GLenum type,
        GLsizei stride, const void *data) {
    GLEncoder *ctx = (GLEncoder*) self;
    assert(ctx->m_state != NULL);
...
void GLEncoder::s_glWeightPointerOES(void *self, int size, GLenum type,
        GLsizei stride, const void *data) {
    GLEncoder *ctx = (GLEncoder*) self;
    assert(ctx->m_state != NULL);
...
void GLEncoder::s_glBufferData(void *self, GLenum target, GLsizeiptr size,
...
void GLEncoder::s_glBufferSubData(void *self, GLenum target, GLintptr offset,
...
void GLEncoder::s_glDeleteBuffers(void *self, GLsizei n,
...
void GLEncoder::sendVertexData(unsigned int first, unsigned int count) {
    ...
    for (int i = 0; i < GLClientState::LAST_LOCATION; i++) {
        ...
        if (i >= GLClientState::TEXCOORD0_LOCATION
            ...
            m_glClientActiveTexture_enc(this,
                    GL_TEXTURE0 + i - GLClientState::TEXCOORD0_LOCATION);
        }
        ...
        if (state->enabled) {
            ...
            if (state->bufferObject == 0) {
                ...
                case GLClientState::VERTEX_LOCATION:
                    this->glVertexPointerData(this, state->size, state->type,
                            state->stride,
                ...
                case GLClientState::COLOR_LOCATION:
                    this->glColorPointerData(this, state->size, state->type,
                            state->stride,
                            (unsigned char*) state->data + firstIndex, datalen);
                    break;
                ...
                case GLClientState::TEXCOORD7_LOCATION:
                    this->glTexCoordPointerData(this,
                            i - GLClientState::TEXCOORD0_LOCATION, state->size,
                            state->type, state->stride,
                            (unsigned char*) state->data + firstIndex, datalen);
                    break;
                case GLClientState::POINTSIZE_LOCATION:
                    this->glPointSizePointerData(this, state->type,
                            state->stride,
                            (unsigned char*) state->data + firstIndex, datalen);
                    break;
                case GLClientState::WEIGHT_LOCATION:
                    this->glWeightPointerData(this, state->size, state->type,
                            state->stride,
                            (unsigned char*) state->data + firstIndex, datalen);
                    break;
                case GLClientState::MATRIXINDEX_LOCATION:
                    this->glMatrixIndexPointerData(this, state->size,
                            state->type, state->stride,
                            (unsigned char*) state->data + firstIndex, datalen);
                    break;
                }
                ...
                switch (i) {
                case GLClientState::VERTEX_LOCATION:
                    this->glVertexPointerOffset(this, state->size, state->type,
                            state->stride,
                            (uintptr_t) state->data + firstIndex);
                    break;
                case GLClientState::NORMAL_LOCATION:
                    this->glNormalPointerOffset(this, state->type,
                            state->stride,
                            (uintptr_t) state->data + firstIndex);
                    break;
                case GLClientState::POINTSIZE_LOCATION:
                    this->glPointSizePointerOffset(this, state->type,
                            state->stride,
                            (uintptr_t) state->data + firstIndex);
                    break;
                case GLClientState::COLOR_LOCATION:
                    this->glColorPointerOffset(this, state->size, state->type,
                            state->stride,
                            (uintptr_t) state->data + firstIndex);
                    break;
                case GLClientState::TEXCOORD0_LOCATION:
                ...
                case GLClientState::TEXCOORD6_LOCATION:
                case GLClientState::TEXCOORD7_LOCATION:
                    this->glTexCoordPointerOffset(this, state->size,
                            state->type, state->stride,
                            (uintptr_t) state->data + firstIndex);
                    break;
                case GLClientState::WEIGHT_LOCATION:
                    this->glWeightPointerOffset(this, state->size, state->type,
                            state->stride,
                            (uintptr_t) state->data + firstIndex);
                    break;
                case GLClientState::MATRIXINDEX_LOCATION:
                    this->glMatrixIndexPointerOffset(this, state->size,
                            state->type, state->stride,
                            (uintptr_t) state->data + firstIndex);
                    break;
                }
...
void GLEncoder::s_glDrawArrays(void *self, GLenum mode, GLint first,
        GLsizei count) {
    GLEncoder *ctx = (GLEncoder*) self;
...
void GLEncoder::s_glDrawElements(void *self, GLenum mode, GLsizei count,
...
void GLEncoder::s_glDeleteTextures(void *self, GLsizei n,
...
void GLEncoder::s_glGetTexParameterfv(void *self, GLenum target, GLenum pname,
        GLfloat *params) {
    GLEncoder *ctx = (GLEncoder*) self;
...
void GLEncoder::s_glGetTexParameteriv(void *self, GLenum target, GLenum pname,
        GLint *params) {
    GLEncoder *ctx = (GLEncoder*) self;
    const GLClientState *state = ctx->m_state;
...
void GLEncoder::s_glGetTexParameterxv(void *self, GLenum target, GLenum pname,
        GLfixed *params) {
    GLEncoder *ctx = (GLEncoder*) self;
    const GLClientState *state = ctx->m_state;
...
void GLEncoder::s_glTexParameterf(void *self, GLenum target, GLenum pname,
        GLfloat param) {
    GLEncoder *ctx = (GLEncoder*) self;
    const GLClientState *state = ctx->m_state;
...
void GLEncoder::s_glTexParameterfv(void *self, GLenum target, GLenum pname,
...
void GLEncoder::s_glTexParameteri(void *self, GLenum target, GLenum pname,
        GLint param) {
    GLEncoder *ctx = (GLEncoder*) self;
    const GLClientState *state = ctx->m_state;
...
void GLEncoder::s_glTexParameterx(void *self, GLenum target, GLenum pname,
        GLfixed param) {
    GLEncoder *ctx = (GLEncoder*) self;
    const GLClientState *state = ctx->m_state;
...
void GLEncoder::s_glTexParameteriv(void *self, GLenum target, GLenum pname,
        const GLint *params) {
    GLEncoder *ctx = (GLEncoder*) self;
    const GLClientState *state = ctx->m_state;
...
void GLEncoder::s_glTexParameterxv(void *self, GLenum target, GLenum pname,
...
size_t GLEncoder::pixelDataSize(GLsizei width, GLsizei height, GLenum format,
        GLenum type, int pack) {
    assert(m_state != NULL);
