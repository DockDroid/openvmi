...
#ifndef OPENVMI_ANDROID_PLATFORM_SERVICE_H_
#define OPENVMI_ANDROID_PLATFORM_SERVICE_H_
...
public:
    static const char* service_name() { return "org.openvmi.PlatformService"; }

    PlatformService(const std::shared_ptr<openvmi::PlatformApiStub> &platform_api_stub);
...
private:
    openvmi::PlatformApiStub::WindowStateUpdate::Window unpack_window_state(const Parcel &data);
    std::shared_ptr<openvmi::PlatformApiStub> platform_api_stub_;
};
} // namespace android
