...
#ifndef OPENVMI_ANDROID_ACTIVITY_MANAGER_INTERFACE_H_
#define OPENVMI_ANDROID_ACTIVITY_MANAGER_INTERFACE_H_
...
public:
    ...
    virtual status_t resizeTask(int32_t id, const openvmi::graphics::Rect &rect, int resize_mode) = 0;
};
...
public:
    ...
    status_t resizeTask(int32_t id, const openvmi::graphics::Rect &rect, int resize_mode);
};
} // namespace android
#endif
