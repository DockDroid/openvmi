...
namespace {
constexpr const char *first_boot_marker_path{"/data/.openvmi_initialized"};
}
...
void PlatformApiStub::update_window_state(const WindowStateUpdate &state) {
    ...
    auto convert_window = [](WindowStateUpdate::Window in, openvmi::protobuf::bridge::WindowStateUpdateEvent_WindowState *out) {
