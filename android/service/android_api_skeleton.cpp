...
void AndroidApiSkeleton::launch_application(openvmi::protobuf::bridge::LaunchApplication const *request,
                                openvmi::protobuf::rpc::Void *response,
...
void AndroidApiSkeleton::set_focused_task(openvmi::protobuf::bridge::SetFocusedTask const *request,
                                          openvmi::protobuf::rpc::Void *response,
                                          google::protobuf::Closure *done) {
    connect_services();
...
void AndroidApiSkeleton::remove_task(openvmi::protobuf::bridge::RemoveTask const *request,
                                     openvmi::protobuf::rpc::Void *response,
                                     google::protobuf::Closure *done) {
  connect_services();
...
void AndroidApiSkeleton::resize_task(openvmi::protobuf::bridge::ResizeTask const *request,
                                     openvmi::protobuf::rpc::Void *response,
                                     google::protobuf::Closure *done) {
  connect_services();
  ...
  if (activity_manager_.get()) {
    ...
    activity_manager_->resizeTask(request->id(),
                                  openvmi::graphics::Rect{r.left(), r.top(), r.right(), r.bottom()},
                                  request->resize_mode());
  } else {
    response->set_error("ActivityManager is not available");
  }
