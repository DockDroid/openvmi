...
#ifndef OPENVMI_ANDROID_PLATFORM_SERVICE_INTERFACE_H_
#define OPENVMI_ANDROID_PLATFORM_SERVICE_INTERFACE_H_
...
public:
    ...
    enum {
        // Keep this synchronized with frameworks/base/services/java/com/android/server/wm/OpenvmiPlatformServiceProxy.java
