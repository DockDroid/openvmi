...
#ifndef OPENVMI_PLATFORM_POLICY_H_
#define OPENVMI_PLATFORM_POLICY_H_
...
class BasePlatform {
 public:
  ...
  virtual std::shared_ptr<wm::Window> create_window(const openvmi::wm::Task::Id &task, const openvmi::graphics::Rect &frame, const std::string &title) = 0;
