...
#include "openvmi/platform/sdl/platform.h"
#include "openvmi/input/device.h"
#include "openvmi/input/manager.h"
#include "openvmi/logger.h"
#include "openvmi/platform/sdl/keycode_converter.h"
#include "openvmi/platform/sdl/window.h"
...
Platform::Platform(
  ...
  INFO("display_frame.width=%d display_frame.height=%d",display_frame.width(), display_frame.height());

  pointer_ = input_manager->create_device();
  pointer_->set_name("openvmi-pointer");
  ...
  keyboard_->set_name("openvmi-keyboard");
