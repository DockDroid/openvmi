...
#ifndef OPENVMI_WM_SINGLE_WINDOW_MANAGER_H_
#define OPENVMI_WM_SINGLE_WINDOW_MANAGER_H_
...
class SingleWindowManager : public Manager {
 public:
  ...
  void setup() override;
  inline std::shared_ptr<Window> get_window(){return window_;}
  ...
  void resize_task(const Task::Id &task, const openvmi::graphics::Rect &rect,
