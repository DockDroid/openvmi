...
#ifndef OPENVMI_BRIDGE_PLATFORM_SERVER_H_
#define OPENVMI_BRIDGE_PLATFORM_SERVER_H_
...
class PlatformApiSkeleton {
 public:
  ...
  void set_clipboard_data(openvmi::protobuf::bridge::ClipboardData const *request,
                          openvmi::protobuf::rpc::Void *response,
                          google::protobuf::Closure *done);
  void get_clipboard_data(openvmi::protobuf::rpc::Void const *request,
                          openvmi::protobuf::bridge::ClipboardData *response,
                          google::protobuf::Closure *done);

  void handle_boot_finished_event(
      const openvmi::protobuf::bridge::BootFinishedEvent &event);
  void handle_window_state_update_event(
      const openvmi::protobuf::bridge::WindowStateUpdateEvent &event);
  void handle_application_list_update_event(
      const openvmi::protobuf::bridge::ApplicationListUpdateEvent &event);
