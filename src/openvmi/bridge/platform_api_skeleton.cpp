...
#include "openvmi/wm/window_state.h"
#include "openvmi/logger.h"
#include "openvmi/rotation_status.h"

#if defined(Status)
#undef Status
#endif // defined(Status)

#include "openvmi_bridge.pb.h"
...
void PlatformApiSkeleton::set_clipboard_data(openvmi::protobuf::bridge::ClipboardData const *request,
...
void PlatformApiSkeleton::get_clipboard_data(openvmi::protobuf::rpc::Void const *request,
                                             openvmi::protobuf::bridge::ClipboardData *response,
                                             google::protobuf::Closure *done) {
  (void)request;
...
void PlatformApiSkeleton::handle_boot_finished_event(const openvmi::protobuf::bridge::BootFinishedEvent&) {
  if (boot_finished_handler_)
    boot_finished_handler_();
}

void PlatformApiSkeleton::handle_window_state_update_event(const openvmi::protobuf::bridge::WindowStateUpdateEvent &event) {
  auto convert_window_state = [](
      const ::openvmi::protobuf::bridge::WindowStateUpdateEvent_WindowState
          &window) {
...
void PlatformApiSkeleton::handle_application_list_update_event(const openvmi::protobuf::bridge::ApplicationListUpdateEvent &event) {
