...
#ifndef OPENVMI_BRIDGE_ANDROID_API_STUB_H_
#define OPENVMI_BRIDGE_ANDROID_API_STUB_H_

#include "openvmi/application/manager.h"
#include "openvmi/common/wait_handle.h"
...
namespace bridge {
class AndroidApiStub : public openvmi::application::Manager {
 public:
  AndroidApiStub();
  ~AndroidApiStub();
  ...
  void resize_task(const std::int32_t &id, const openvmi::graphics::Rect &rect,
