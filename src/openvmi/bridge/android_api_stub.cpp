...
void AndroidApiStub::launch(const android::Intent &intent,
  ...
  case wm::Stack::Id::Default:
    message.set_stack(::openvmi::protobuf::bridge::LaunchApplication_Stack_DEFAULT);
    break;
  case wm::Stack::Id::Fullscreen:
    message.set_stack(::openvmi::protobuf::bridge::LaunchApplication_Stack_FULLSCREEN);
    break;
  case wm::Stack::Id::Freeform:
    message.set_stack(::openvmi::protobuf::bridge::LaunchApplication_Stack_FREEFORM);
    break;
  default:
    break;
  }
