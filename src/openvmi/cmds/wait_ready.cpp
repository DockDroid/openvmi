...
#include "openvmi/dbus/stub/application_manager.h"

namespace {
constexpr const unsigned int max_wait_attempts{30};
}

openvmi::cmds::WaitReady::WaitReady()
  ...
  action([this](const cli::Command::Context&) {
    auto bus_type = openvmi::dbus::Bus::Type::Session;
    if (use_system_dbus_)
      bus_type = openvmi::dbus::Bus::Type::System;
    auto bus = std::make_shared<openvmi::dbus::Bus>(bus_type);
