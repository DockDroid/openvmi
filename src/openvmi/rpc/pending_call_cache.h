...
#ifndef OPENVMI_RPC_PENDING_CALL_CACHE_
#define OPENVMI_RPC_PENDING_CALL_CACHE_
...
class PendingCallCache {
 public:
  ...
  void save_completion_details(
      openvmi::protobuf::rpc::Invocation const &invocation,
      google::protobuf::MessageLite *response,
      google::protobuf::Closure *complete);
  void populate_message_for_result(
      openvmi::protobuf::rpc::Result &result,
      std::function<void(google::protobuf::MessageLite *)> const &populator);
  void complete_response(openvmi::protobuf::rpc::Result &result);
