...
#include "openvmi/rpc/make_protobuf_object.h"
#include "openvmi/rpc/template_message_processor.h"
...
bool MessageProcessor::process_data(const std::vector<std::uint8_t> &data) {
  ...
  while (buffer_.size() > 0) {
    ...
    if (message_type == MessageType::invocation) {
      openvmi::protobuf::rpc::Invocation raw_invocation;
...
void MessageProcessor::send_response(::google::protobuf::uint32 id,
  ...
  openvmi::protobuf::rpc::Result send_response_result;
