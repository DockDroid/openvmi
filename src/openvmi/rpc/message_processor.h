...
#ifndef OPENVMI_RPC_MESSAGE_PROCESSOR_H_
#define OPENVMI_RPC_MESSAGE_PROCESSOR_H_
...
class Invocation {
 public:
  Invocation(openvmi::protobuf::rpc::Invocation const& invocation)
 ...
 private:
  openvmi::protobuf::rpc::Invocation const& invocation_;
};
