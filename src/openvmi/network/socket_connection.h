...
#ifndef OPENVMI_NETWORK_SOCKET_CONNECTION_H_
#define OPENVMI_NETWORK_SOCKET_CONNECTION_H_

#include "openvmi/network/connections.h"
#include "openvmi/network/message_processor.h"
#include "openvmi/network/message_receiver.h"
...
class SocketConnection {
 public:
  ...
  std::shared_ptr<MessageReceiver> get_message() {
