...
#include "openvmi/network/tcp_socket_connector.h"
#include "openvmi/network/connection_context.h"
#include "openvmi/network/socket_helper.h"

namespace openvmi {
namespace network {
TcpSocketConnector::TcpSocketConnector(
    const boost::asio::ip::address_v4& address, unsigned int port,
