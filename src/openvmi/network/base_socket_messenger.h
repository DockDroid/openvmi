...
#ifndef OPENVMI_NETWORK_BASE_SOCKET_MESSENGER_H_
#define OPENVMI_NETWORK_BASE_SOCKET_MESSENGER_H_

#include "openvmi/common/fd_sets.h"
...
class BaseSocketMessenger : public SocketMessenger {
 public:
  ...
  void async_receive_msg(OpenvmiReadHandler const& handle,
