...
#include "openvmi/network/delegate_connection_creator.h"
#include "openvmi/network/delegate_message_processor.h"
#include "openvmi/network/tcp_socket_messenger.h"
...
const unsigned int default_host_listen_port{ openvmiadbport }; /* adbd running on guest (client) */
...
//        boost::asio::ip::address_v4::from_string(loopback_address),
    ...
    auto message = utils::string_format("host:emulator:%d", openvmiadbport);
