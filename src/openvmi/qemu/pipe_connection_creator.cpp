...
#include "openvmi/graphics/opengles_message_processor.h"
...
#include "openvmi/qemu/adb_message_processor.h"
#include "openvmi/qemu/boot_properties_message_processor.h"
#include "openvmi/qemu/bootanimation_message_processor.h"
#include "openvmi/qemu/camera_message_processor.h"
#include "openvmi/qemu/fingerprint_message_processor.h"
#include "openvmi/qemu/gsm_message_processor.h"
#include "openvmi/qemu/hwcontrol_message_processor.h"
#include "openvmi/qemu/null_message_processor.h"
#include "openvmi/qemu/pipe_connection_creator.h"
#include "openvmi/qemu/sensors_message_processor.h"

namespace ba = boost::asio;

namespace {
std::string client_type_to_string(
    const openvmi::qemu::PipeConnectionCreator::client_type &type) {
  switch (type) {
    case openvmi::qemu::PipeConnectionCreator::client_type::opengles:
      return "opengles";
    case openvmi::qemu::PipeConnectionCreator::client_type::qemud_boot_properties:
      return "boot-properties";
    case openvmi::qemu::PipeConnectionCreator::client_type::qemud_hw_control:
      return "hw-control";
    case openvmi::qemu::PipeConnectionCreator::client_type::qemud_sensors:
      return "sensors";
    case openvmi::qemu::PipeConnectionCreator::client_type::qemud_camera:
      return "camera";
    case openvmi::qemu::PipeConnectionCreator::client_type::qemud_fingerprint:
      return "fingerprint";
    case openvmi::qemu::PipeConnectionCreator::client_type::qemud_gsm:
      return "gsm";
    case openvmi::qemu::PipeConnectionCreator::client_type::qemud_adb:
      return "adb";
    case openvmi::qemu::PipeConnectionCreator::client_type::bootanimation:
      return "boot-animation";
    case openvmi::qemu::PipeConnectionCreator::client_type::invalid:
      break;
    default:
      break;
  }
